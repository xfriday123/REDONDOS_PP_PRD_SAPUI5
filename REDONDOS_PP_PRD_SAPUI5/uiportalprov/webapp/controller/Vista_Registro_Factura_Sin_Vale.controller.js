sap.ui.define([
	...
	return Controller.extend("nsrdos.uiportalprov.controller.Vista_Registro_Factura_Sin_Vale", {
		...
		funValidarEstadoInsert: function (EM_RUC, US_RUC, ID_FACTURA, date, time) {
			if (this.varTotalInsert === this.varTotalInsertEje) {
                ...
                var oHeaders = { 'X-CSRF-Token': this.token }
                $.ajax(this.varTableURL + "/" + this.varTableT_FAC + "(EM_RUC='" + EM_RUC + "',US_RUC='" + US_RUC + "',ID_FACTURA='" + ID_FACTURA + "')", {
					type: 'PATCH',
                    data: oVectorJSON,		
                    headers: oHeaders,						
                    contentType: "application/json",
