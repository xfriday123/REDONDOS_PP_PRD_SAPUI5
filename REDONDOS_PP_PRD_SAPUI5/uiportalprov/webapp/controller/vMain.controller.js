sap.ui.define([
    ...
    return Controller.extend("nsrdos.uiportalprov.controller.vMain", {
        ...
        onAfterRendering: function () {
            ...
            this.btnIngresar2("99999999999", "Rivercon2019+");
        },
        ...
        btnIngresar: function () {
            ...
            if (canContinue) {
                ...
                if (Input1 === Input2) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: this.varTableURL + "/" + this.varTableT_USER + "?$format=json&$filter=US_USUARIO eq '" + varUsuario + "' and US_CONTRASENA eq '" + varPasswordEncriptado + "' and ESTADO eq '" + "a" + "'",
                        success: function (response) {
                                                ...
                                                if (canContinue) {
                                                    ...
                                                    if (varPassAne === varPassbds) {
                                                        if (varPassNew === varPassRep) {
                                                            ...
                                                            $.ajax(this.varTableURL + this.varTableT_USER + "(US_USUARIO='" + varUsuario + "')", {
                                                                method: "PUT",
                                                                data: oVectorJSON,
                                                                headers: oHeaders,
        ...
        btnIngresar2: function (oUsuario, oPassword) {
            ...
            if (Input1 === Input2 || Input1 !== Input2) {
                ...
                //var varUsuario = this.getView().byId("idUsuario").getValue();
                var varUsuario = oUsuario;
                filter = new sap.ui.model.Filter("US_USUARIO", sap.ui.model.FilterOperator.EQ, varUsuario);
                filters.push(filter);
                var varPassword = oPassword;
                var varPasswordEncriptado = this.funEncriptar(varPassword).substring(0, 29).toString();
                filter = new sap.ui.model.Filter("US_CONTRASENA", sap.ui.model.FilterOperator.EQ, varPasswordEncriptado);
                filters.push(filter);
                filter = new sap.ui.model.Filter("ESTADO", sap.ui.model.FilterOperator.EQ, "a");
                ...
                beginButton: new sap.m.Button({
                    ...
                    press: function () {
                        ...
                        if (canContinue) {
                            ...
                            $.ajax({
                                type: "GET",
                                url: this.varTableURL + "/" + this.varTableT_USER + "?$format=json&$filter=US_USUARIO eq '" + varUsuarioG + "' and ESTADOG eq '" + "O" + "'",
                                success: function (responseG) {
                                    ...
                                    if (tamTablaG !== 0) {
                                        ...
                                        $.ajax({
                                            type: "GET",
                                            url: this.varTableURL + "/" + this.varTableT_USER + "?$format=json&$filter=US_USUARIO eq '" + varUsuario + "' and TOLERANCIA eq '" + "yes" + "'",
                                            success: function (response) {
                                                ...
                                                if (tamTabla !== 0) {
                                                    ...
                                                    $.ajax(this.varTableURL + this.varTableT_USER + "(US_USUARIO='" + varbdRUC + "')", {
                                                        method: "PUT",
                                                        data: oVectorJSON,
                                                        headers: oHeaders,
                                                        contentType: "application/json;IEEE754Compatible=true",
