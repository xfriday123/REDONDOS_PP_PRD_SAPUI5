sap.ui.define([
    ...
    return Controller.extend("nsrdos.uiportalprov.controller.Vista_Reporte_Factura", {
        ...
        f_obtener_numero_serie_factura: function (s_nombre, s_separador) {

            var varNumFactura = s_nombre;
            var varProductstxt = "";
            var vectorProductstxt = [];
            var llaveProductstxt = {};
            for (var k = 0; k < varNumFactura.length; k++) {
                if (varNumFactura.substring(k, k + 1) !== s_separador) {
                    varProductstxt = varProductstxt + varNumFactura.substring(k, k + 1);
                }
                if (varNumFactura.substring(k, k + 1) === s_separador || k === varNumFactura.length - 1) {
                    llaveProductstxt = {};
            ...
            return vectorProductstxt;
        },

        f_anadir_ceros: function (s_valor) {

            var o_respuesta = "";

            if (s_valor.length === 1) {
                o_respuesta = "0000000" + s_valor;
            } else if (s_valor.length === 2) {
                o_respuesta = "000000" + s_valor;
            } else if (s_valor.length === 3) {
                o_respuesta = "00000" + s_valor;
            } else if (s_valor.length === 4) {
                o_respuesta = "0000" + s_valor;
            } else if (s_valor.length === 5) {
                o_respuesta = "000" + s_valor;
            } else if (s_valor.length === 6) {
                o_respuesta = "00" + s_valor;
            } else if (s_valor.length === 7) {
                o_respuesta = "0" + s_valor;
            } else if (s_valor.length === 8) {
                o_respuesta = "" + s_valor;
            }
        ...
        pressDocumento: function (evt) {
            ...
            var archivoValidar2 = objeto.NOMBRE_DOC;
            $.ajax('/dms/' + archivoValidar2, {
                ...
                error: function (response) {
                    ...
                    if (response.status === 404 || response.status === 500) {
                        ...
                        var o_vector_1 = this.f_obtener_numero_serie_factura(objeto.NOMBRE_DOC, "-");
                        var o_valor_1 = o_vector_1[0].Dato;
                        var o_valor_2 = o_vector_1[1].Dato;
                        var o_valor_3 = o_vector_1[2].Dato;
                        var o_valor_4 = o_vector_1[3].Dato;
                        console.log(o_valor_1);
                        console.log(o_valor_2);
                        console.log(o_valor_3);
                        console.log(o_valor_4);

                        var o_vector_2 = this.f_obtener_numero_serie_factura(o_valor_4, ".");
                        var o_valor_5 = this.f_anadir_ceros(o_vector_2[0].Dato);
                        var o_valor_6 = o_vector_2[1].Dato;
                        console.log(o_valor_5);
                        console.log(o_valor_6);

                        var o_res_nom = o_valor_1 + "-" + o_valor_2 + "-" + o_valor_3 + "-" + o_valor_5 + "." + o_valor_6;
                        console.log(o_res_nom);

                        var filename = o_res_nom;
                        var uri = "/dms/" + filename;
                        var link = document.createElement("a");
                        link.download = filename;
                        link.href = uri;
            ...
            $.ajax('/dms/' + objeto.NOMBRE_DOC, {
                ...
                success: function (response) {
					...
					/*oModelOdata.remove("/" + this.varTableT_DOC + "(EM_RUC='" + objeto.EM_RUC + "',US_RUC='" + objeto.US_RUC +
						...
						"')", {*/
                    var oHeaders = { 'X-CSRF-Token': this.token }
                    $.ajax(this.varTableURL + "/" + this.varTableT_DOC + "(EM_RUC='" + objeto.EM_RUC + "',US_RUC='" + objeto.US_RUC +
                        "',ID_FACTURA='" + objeto.ID_FACTURA +
                        "',POS_DOCUMENTO='" + objeto.POS_DOCUMENTO +
                        "')", {
                        type: 'DELETE',
                        ...
                        success: function (data) {
                            ...
                            $.ajax({
                                type: "GET",
                                url: this.varTableURL + "/" + this.varTableT_DOC + "?$format=json&$filter=ID_FACTURA eq '" + ID_FACTURA + "'",
                                success: function (response) {
        ...
        onChangeFile: function (evt) {
            ...
            $.ajax('/dms', {
                ...
                success: function (response) {
                    ...
                    var oVectorJSON = JSON.stringify(llaveDocumento);
                    var oHeaders = { 'X-CSRF-Token': this.token };
                    $.ajax(this.varTableURL + "/" + this.varTableT_DOC, {
                        ...
                        success: function (data) {
                            ...
                            $.ajax({
                                type: "GET",
                                url: this.varTableURL + "/" + this.varTableT_DOC + "?$format=json&$filter=ID_FACTURA eq '" + data.ID_FACTURA + "'",
                                success: function (response) {
        ...
        btnBuscarItem: function (oEvent) {
            ...
            var oDialogSelectItems = new sap.m.Dialog("idDialogSelectItems", {
                ...
                afterOpen: function () {
                    ...
                    $.ajax({
                        type: "GET",
                        url: this.varTableURL + "/" + this.varTableT_FAC_POS + "?$format=json&$filter=ID_FACTURA eq '" + factura.ID_FACTURA + "' and POS_FACTURA eq '" + factura.POS_FACTURA + "'",
                        success: function (response) {
        ...
        btnBuscarItem2: function (oEvent) {
            ...
            var oDialogSelectItems = new sap.m.Dialog("idDialogSelectItems", {
                ...
                afterOpen: function () {
                    ...
                    $.ajax({
                        type: "GET",
                        url: this.varTableURL + "/" + this.varTableT_FAC_POS + "?$format=json&$filter=ID_FACTURA eq '" + factura.ID_FACTURA + "' and POS_FACTURA eq '" + factura.POS_FACTURA + "' and EM_RUC eq '" + varRUC + "' and US_RUC eq '" + varUsuario + "'",
                        success: function (response) {
        ...
        clicItemFactura: function (oEvent) {
            ...
            $.ajax({
                type: "GET",
                url: this.varTableURL + "/" + this.varTableT_FAC_DET + "?$format=json&$filter=ID_FACTURA eq '" + factura.ID_FACTURA + "' and EM_RUC eq '" + varRUC + "' and US_RUC eq '" + varUsuario + "'",
                success: function (response) {
                    var oModelJSON = new sap.ui.model.json.JSONModel(response.value);
                    var lenghtV = oModelJSON.getData().length;
            ...
            while (this.oGlobalStop10 === "S") {
                $.ajax({
                    type: "GET",
                    async: false,
                    url: this.varTableURL + "/" + this.varTableT_FAC_POS + "?$format=json&$skiptoken=" + this.oGlobalIteracion0 + "&$filter=ID_FACTURA eq '" + factura.ID_FACTURA + "' and EM_RUC eq '" + varRUC + "' and US_RUC eq '" + varUsuario + "'",
                    success: function (response) {
            ...
            $.ajax({
                type: "GET",
                url: this.varTableURL + "/" + this.varTableT_DOC + "?$format=json&$filter=ID_FACTURA eq '" + factura.ID_FACTURA + "' and EM_RUC eq '" + varRUC + "' and US_RUC eq '" + varUsuario + "'",
                success: function (response) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (this.oEntrar === "S") {
                            ...
                            oModel2.setProperty("/listFactura", matrix.length > 0 ? matrix.filter(e => e.FC_FEC_REGISTRO !== null).sort( (e, t) => t.FC_FEC_REGISTRO.localeCompare(e.FC_FEC_REGISTRO)).concat(matrix.filter(e => e.FC_FEC_REGISTRO === null)) : []);
        ...
        ressEliminarFactura2: function () {
            ...
            var oVectorJSON = JSON.stringify(llaveActualizarab);
            var oHeaders = { 'X-CSRF-Token': this.token }
                ...
                success: function (data) {
                    ...
                    if (listDocAdjuntarFac.length !== 0) {
                        for (var d1 = 0; d1 < listDocAdjuntarFac.length; d1++) {
                            ...
                            //var oConsultaDocResponse = this._getDatadocsust("/dms/", listDocAdjuntarFac[d1].NOMBRE_DOC);
                            ...
                            if (oConsultaDoc.length > 1 && oConsultaDoc != false) {
                                ...
                                if (oDeleteDocRepo === "V" || oDeleteDocRepo !== "V") { //MM-20240212
                ...
                success: function (response) {
                    ...
                    for (var j = 0; j < listItemFacturaPosicion.length; j++) {
                        ...
                        if (varTipoCargaDefinir === "S" || varTipoCargaDefinir === "H" || varTipoCargaDefinir === "D") {
                            ...
                            var oVectorJSON = JSON.stringify(llaveActualizarC);
                            var oHeaders = { 'X-CSRF-Token': this.token }
                            $.ajax(this.varTableURL + actOrdenConsignacion, {
                                type: 'PATCH',
                                data: oVectorJSON,
                                headers: oHeaders,
                                contentType: "application/json",
                    ...
                    for (var d = 0; d < listDocAdjuntarFac.length; d++) {
                        ...
                        var oHeaders = { 'X-CSRF-Token': this.token };
                        $.ajax("/dms/" + listDocAdjuntarFac[d].NOMBRE_DOC, {
                            /*type: 'POST',
                            data: formData,
                            cache: false,
                            processData: false,
