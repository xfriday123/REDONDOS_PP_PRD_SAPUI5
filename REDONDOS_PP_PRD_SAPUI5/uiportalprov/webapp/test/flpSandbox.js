		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#nsrdosuiportalprov-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsrdosuiportalprov-display": {
								"semanticObject": "nsrdosuiportalprov",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nsrdos.uiportalprov",
									"url": sap.ui.require.toUrl("nsrdos/uiportalprov")
								}
							}
						}
					}
